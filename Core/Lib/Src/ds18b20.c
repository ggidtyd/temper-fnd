...
float getTemper()
{
	Ds18b20Delay(100);
	m_busy = 1;
	tempersensor.DataIsValid = DS18B20_Read(&OneWire, tempersensor.Address,
			&tempersensor.Temperature);
	m_busy = 0;
